class ProductList {
    constructor (productsUrl, renderContainer, renderCarousel, cart) {
        this.cart = cart;
        fetch(productsUrl)
            ...
            .then(products => {
                ...
                this.renderCarusel(renderCarousel, products);
    ...
    renderCarusel(container, products) {
        let productListDomString = container.contents()[1].outerHTML;
        products.forEach(product => {
            productListDomString += 
